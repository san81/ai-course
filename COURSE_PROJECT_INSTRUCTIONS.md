# AI Course — Recurring Project Instructions

These instructions apply to ALL future work in this project (AI Course Tutoring).

## Course context
- 8-week graduate course, mixed technical background (some coders, some not).
- Master schedule: `AI_Course_Schedule_8_Weeks.xlsx` (Overview + week-by-week Schedule).
- Sequence: History → How AI works → Prompting/everyday use → Research tools → Building with APIs → RAG → Agents & integrations → Ethics + capstone.

## Presentation format
- Weekly material = single-file, self-contained HTML slide deck (reveal.js style), one per week.
...
2. **Easter egg question** — a hidden/curiosity question posed up front; students must pay attention to this week's material to answer it at the end. Answers feed a semester-long meta-puzzle revealed in Week 8.
3. **AI Fail of the Week** (optional, once rhythm is established) — a 2-min real-world AI blunder that teaches limitations.
4. **This week's topic deep dive** — the main content.
5. **This week's exercise** — two tiers: "core" (everyone) and "stretch" (technically ambitious students).
...
- Weekly decks linked from the landing page, released on schedule.

## Workflow with the user (Santhosh)
- Iterate on decks as HTML so edits are fast.
- When preparing a new week, first check the schedule file for that week's topics, lab, tools, and assignment.
- Ask for feedback on student comprehension after sessions and adjust upcoming material depth accordingly.
